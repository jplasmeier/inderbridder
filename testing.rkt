...
(string-append "test 4: " (if (eq? (interpret-file "tests/test4.txt" ) 16) "passed" "failed")) 
...
(string-append "test 19: " (if (eq? (interpret-file "tests/test19.txt" ) 128) "passed" "failed")) 
(string-append "test 20: " (if (eq? (interpret-file "tests/test20.txt" ) 12) "passed" "failed")) 
